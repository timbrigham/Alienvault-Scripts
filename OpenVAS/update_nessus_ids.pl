...
# trbdk3 - add "ignore" into query definition. It's quite possible to have duplicate entries.
...
# trbdk3 - add output to show what IDs and keys are being processed.
...
# trbdk3. this is another option instead of ignoring updates
